...
export default async function LoginPage() {
  ...
  return (
      !!session ? (  
        ...
        <div className="w-[450px]  top-0 fixed bg-center bg-cover  h-full md:block hidden bg-[url('https://res.cloudinary.com/dmlts9lbk/image/upload/v1704833428/pexels-anna-nekrashevich-6802049_smnlna.jpg')] "></div>
    <div className="p-4 max-w-md bg-primmary md:pt-0 pt-28 md:absolute md:top-1/3 md:left-1/2 flex flex-col items-center justify-center  mx-auto">
        ...
        <Link href="/account">
            <button className="bg-white flex items-center justify-center gap-x-1 w-full px-4 py-2 rounded-sm "><RiDashboard2Line className="text-xl"/>Dashboard</button>
        </Link>
