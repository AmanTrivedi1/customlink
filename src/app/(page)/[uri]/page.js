  ...
  try {
    ...
    return (
      <div className="bg-normal-dark text-white  ">
        ...
        <div className="md:max-w-2xl max-w-xs mx-auto p-2 text-gray-300 text-center my-2">
          <h1 className="text-start mb-3 text-white font-semibold text-2xl">
            About me
          </h1>
            ...
            >
              ...
              <div className="flex items-center rounded-l-lg  ml-4 justify-center max-w-32 shrink grow-0 overflow-hidden">
                <div>
                  ...
                  <p className="text-white/50 h-6  line-clamp-1">
                    {link.subtitle}
                  </p>
                </div>
              </div>
    ...
    return (
      <div className="text-white flex-col flex items-center justify-center h-screen ">
        <img className="max-w-xs" src="https://res.cloudinary.com/dmlts9lbk/image/upload/v1705598420/empty_u3jzi3.png" alt="empty image"/>
        <div>
            <h1 className="text-center md:text-4xl sm:text-2xl text-xl font-semibold">Looks like link is invalid</h1>
        </div>
        <div className="text-center">
          <p className="md:text-base sm:text-sm text-xs">Reaturn back via availble option you will<br/> be redirect to userpage</p>
        </div>
      </div>
    );
  }
