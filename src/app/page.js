...
export default function Home() {
  return (
    <>
   <main className="bg-primmary md:h-screen h-full">
       <Header/>
     <section className=" md:px-0 px-4 2xl:max-w-7xl max-w-6xl m-auto flex md:flex-row flex-col-reverse justify-between">
